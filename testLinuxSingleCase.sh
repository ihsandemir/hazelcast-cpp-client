...
${BUILD_DIR}/hazelcast/test/src/${EXECUTABLE_NAME} --gtest_output="xml:CPP_Client_Test_Report.xml" --gtest_filter=Ticket5344Test.testTicket5344_WaitForLifeCycleListener &
testPid=$!
wait ${testPid}
result=$?
