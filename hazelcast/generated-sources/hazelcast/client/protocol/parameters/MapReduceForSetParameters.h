 ...
 */
#ifndef HAZELCAST_CLIENT_MAPREDUCEFORSETPARAMETERS_H_
#define HAZELCAST_CLIENT_MAPREDUCEFORSETPARAMETERS_H_
    ...
    namespace client {
        ...
        namespace protocol {
            ...
            namespace parameters {
                class HAZELCAST_API MapReduceForSetParameters {
                public:
                    static const protocol::GeneratedMessageType TYPE = protocol::MAPREDUCE_FORSET;
...
#endif /* HAZELCAST_CLIENT_MAPREDUCEFORSETPARAMETERS_H_ */
