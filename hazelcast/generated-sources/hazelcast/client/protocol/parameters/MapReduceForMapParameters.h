 ...
 */
#ifndef HAZELCAST_CLIENT_MAPREDUCEFORMAPPARAMETERS_H_
#define HAZELCAST_CLIENT_MAPREDUCEFORMAPPARAMETERS_H_
    ...
    namespace client {
        ...
        namespace protocol {
            ...
            namespace parameters {
                class HAZELCAST_API MapReduceForMapParameters {
                public:
                    static const protocol::GeneratedMessageType TYPE = protocol::MAPREDUCE_FORMAP;
...
#endif /* HAZELCAST_CLIENT_MAPREDUCEFORMAPPARAMETERS_H_ */
