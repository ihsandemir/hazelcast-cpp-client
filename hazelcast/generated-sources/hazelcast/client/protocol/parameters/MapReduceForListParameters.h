 ...
 */
#ifndef HAZELCAST_CLIENT_MAPREDUCEFORLISTPARAMETERS_H_
#define HAZELCAST_CLIENT_MAPREDUCEFORLISTPARAMETERS_H_
    ...
    namespace client {
        ...
        namespace protocol {
            ...
            namespace parameters {
                class HAZELCAST_API MapReduceForListParameters {
                public:
                    static const protocol::GeneratedMessageType TYPE = protocol::MAPREDUCE_FORLIST;
...
#endif /* HAZELCAST_CLIENT_MAPREDUCEFORLISTPARAMETERS_H_ */
