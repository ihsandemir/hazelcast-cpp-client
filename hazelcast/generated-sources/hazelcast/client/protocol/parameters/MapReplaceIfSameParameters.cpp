    ...
    namespace client {
        namespace protocol {
            namespace parameters {
                    std::auto_ptr<ClientMessage> MapReplaceIfSameParameters::encode(
                        ...
                        clientMessage->setMessageType((uint16_t)MapReplaceIfSameParameters::TYPE);
                        clientMessage->set(name).set(key).set(testValue).set(value).set(threadId);
                        clientMessage->updateFrameLength();
                        return clientMessage;
                    }

                    int32_t MapReplaceIfSameParameters::calculateDataSize(
                            const std::string &name, 
                            const serialization::pimpl::Data &key, 
                            const serialization::pimpl::Data &testValue, 
                            const serialization::pimpl::Data &value, 
                        ...
                        return ClientMessage::HEADER_SIZE
                             ...
                             + ClientMessage::calculateDataSize(testValue)
