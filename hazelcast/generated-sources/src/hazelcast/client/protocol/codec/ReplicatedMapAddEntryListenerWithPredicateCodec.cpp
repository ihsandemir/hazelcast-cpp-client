...
namespace hazelcast {
    namespace client {
        namespace protocol {
            namespace codec {
                const ReplicatedMapMessageType ReplicatedMapAddEntryListenerWithPredicateCodec::RequestParameters::TYPE = REPLICATEDMAP_ADDENTRYLISTENERWITHPREDICATE;
                const bool ReplicatedMapAddEntryListenerWithPredicateCodec::RequestParameters::RETRYABLE = true;
                ...
                void ReplicatedMapAddEntryListenerWithPredicateCodec::AbstractEventHandler::handle(std::auto_ptr<protocol::ClientMessage> clientMessage) {
                    ...
                    switch (messageType) {
                        ...
                        default:
                            char buf[300];
                            sprintf(buf, "[ReplicatedMapAddEntryListenerWithPredicateCodec::AbstractEventHandler::handle] Unknown message type (%d) received on event handler.", clientMessage->getMessageType());
