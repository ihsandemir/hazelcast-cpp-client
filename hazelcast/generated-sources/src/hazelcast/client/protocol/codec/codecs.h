    ...
    namespace client {
        namespace protocol {
            namespace codec {
                 ...
                 */
                 ClientMessage HAZELCAST_API client_createproxy_encode(std::string const & name, std::string const & serviceName);

                /**
                 * Destroys the proxy given by its name cluster-wide. Also, clears and releases all resources of this proxy.
                 */
                 ClientMessage HAZELCAST_API client_destroyproxy_encode(std::string const & name, std::string const & serviceName);
                 ...
                 */
                 ClientMessage HAZELCAST_API client_statistics_encode(int64_t timestamp, std::string const & clientAttributes, std::vector<byte> const & metricsBlob);
                 ...
                 */
                 ClientMessage HAZELCAST_API client_deployclasses_encode(std::vector<std::pair<std::string, std::vector<byte>>> const & classDefinitions);
                 ...
                 */
                 ClientMessage HAZELCAST_API client_createproxies_encode(std::vector<std::pair<std::string, std::string>> const & proxies);
                 ...
                 */
                 ClientMessage HAZELCAST_API map_put_encode(std::string const & name, Data const & key, Data const & value, int64_t threadId, int64_t ttl);
                 ...
                 */
                 ClientMessage HAZELCAST_API map_get_encode(std::string const & name, Data const & key, int64_t threadId);
                 ...
                 * call returns.
                 */
                 ClientMessage HAZELCAST_API map_remove_encode(std::string const & name, Data const & key, int64_t threadId);

                /**
                 * Replaces the entry for a key only if currently mapped to a given value.
                 */
                 ClientMessage HAZELCAST_API map_replace_encode(std::string const & name, Data const & key, Data const & value, int64_t threadId);

                /**
                 * Replaces the the entry for a key only if existing values equal to the testValue
                 */
                 ClientMessage HAZELCAST_API map_replaceifsame_encode(std::string const & name, Data const & key, Data const & testValue, Data const & value, int64_t threadId);

                /**
                 * Returns true if this map contains a mapping for the specified key.
                 */
                 ClientMessage HAZELCAST_API map_containskey_encode(std::string const & name, Data const & key, int64_t threadId);
                 ...
                 */
                 ClientMessage HAZELCAST_API map_containsvalue_encode(std::string const & name, Data const & value);

                /**
                 * Removes the mapping for a key from this map if existing value equal to the this value
                 */
                 ClientMessage HAZELCAST_API map_removeifsame_encode(std::string const & name, Data const & key, Data const & value, int64_t threadId);
                 ...
                 */
                 ClientMessage HAZELCAST_API map_delete_encode(std::string const & name, Data const & key, int64_t threadId);
                 ...
                 */
                 ClientMessage HAZELCAST_API map_flush_encode(std::string const & name);
                 ...
                 */
                 ClientMessage HAZELCAST_API map_tryremove_encode(std::string const & name, Data const & key, int64_t threadId, int64_t timeout);
                 ...
                 */
                 ClientMessage HAZELCAST_API map_tryput_encode(std::string const & name, Data const & key, Data const & value, int64_t threadId, int64_t timeout);
                 ...
                 */
                 ClientMessage HAZELCAST_API map_puttransient_encode(std::string const & name, Data const & key, Data const & value, int64_t threadId, int64_t ttl);
                 ...
                 */
                 ClientMessage HAZELCAST_API map_putifabsent_encode(std::string const & name, Data const & key, Data const & value, int64_t threadId, int64_t ttl);
                 ...
                 */
                 ClientMessage HAZELCAST_API map_set_encode(std::string const & name, Data const & key, Data const & value, int64_t threadId, int64_t ttl);
                 ...
                 */
                 ClientMessage HAZELCAST_API map_lock_encode(std::string const & name, Data const & key, int64_t threadId, int64_t ttl, int64_t referenceId);
                 ...
                 */
                 ClientMessage HAZELCAST_API map_trylock_encode(std::string const & name, Data const & key, int64_t threadId, int64_t lease, int64_t timeout, int64_t referenceId);

                /**
                 * Checks the lock for the specified key.If the lock is acquired then returns true, else returns false.
                 */
                 ClientMessage HAZELCAST_API map_islocked_encode(std::string const & name, Data const & key);
                 ...
                 */
                 ClientMessage HAZELCAST_API map_unlock_encode(std::string const & name, Data const & key, int64_t threadId, int64_t referenceId);

                /**
                 * Adds an interceptor for this map. Added interceptor will intercept operations
                 * and execute user defined methods and will cancel operations if user defined method throw exception.
                 */
                 ClientMessage HAZELCAST_API map_addinterceptor_encode(std::string const & name, Data const & interceptor);

                /**
                 * Removes the given interceptor for this map so it will not intercept operations anymore.
                 */
                 ClientMessage HAZELCAST_API map_removeinterceptor_encode(std::string const & name, std::string const & id);

                /**
                 * Adds a MapListener for this map. To receive an event, you should implement a corresponding MapListener
                 * sub-interface for that event.
                 */
                 ClientMessage HAZELCAST_API map_addentrylistenertokeywithpredicate_encode(std::string const & name, Data const & key, Data const & predicate, bool includeValue, int32_t listenerFlags, bool localOnly);
                 ...
                 */
                 ClientMessage HAZELCAST_API map_addentrylistenerwithpredicate_encode(std::string const & name, Data const & predicate, bool includeValue, int32_t listenerFlags, bool localOnly);
                 ...
                 * sub-interface for that event.
                 */
                 ClientMessage HAZELCAST_API map_addentrylistenertokey_encode(std::string const & name, Data const & key, bool includeValue, int32_t listenerFlags, bool localOnly);
                 ...
                 * sub-interface for that event.
                 */
                 ClientMessage HAZELCAST_API map_addentrylistener_encode(std::string const & name, bool includeValue, int32_t listenerFlags, bool localOnly);
                 ...
                 */
                 ClientMessage HAZELCAST_API map_removeentrylistener_encode(std::string const & name, boost::uuids::uuid registrationId);
                 ...
                 */
                 ClientMessage HAZELCAST_API map_addpartitionlostlistener_encode(std::string const & name, bool localOnly);
                 ...
                 * change in the cluster and returns false.
                 */
                 ClientMessage HAZELCAST_API map_removepartitionlostlistener_encode(std::string const & name, boost::uuids::uuid registrationId);
                 ...
                 */
                 ClientMessage HAZELCAST_API map_getentryview_encode(std::string const & name, Data const & key, int64_t threadId);
                 ...
                 */
                 ClientMessage HAZELCAST_API map_evict_encode(std::string const & name, Data const & key, int64_t threadId);
                 ...
                 */
                 ClientMessage HAZELCAST_API map_evictall_encode(std::string const & name);

                /**
                 * Loads all keys into the store. This is a batch load operation so that an implementation can optimize the multiple loads.
                 */
                 ClientMessage HAZELCAST_API map_loadall_encode(std::string const & name, bool replaceExistingValues);

                /**
                 * Loads the given keys. This is a batch load operation so that an implementation can optimize the multiple loads.
                 */
                 ClientMessage HAZELCAST_API map_loadgivenkeys_encode(std::string const & name, std::vector<Data> const & keys, bool replaceExistingValues);
                 ...
                 */
                 ClientMessage HAZELCAST_API map_keyset_encode(std::string const & name);
                 ...
                 */
                 ClientMessage HAZELCAST_API map_getall_encode(std::string const & name, std::vector<Data> const & keys);
                 ...
                 */
                 ClientMessage HAZELCAST_API map_values_encode(std::string const & name);
                 ...
                 * if query result size limit is configured.
                 */
                 ClientMessage HAZELCAST_API map_entryset_encode(std::string const & name);
                 ...
                 */
                 ClientMessage HAZELCAST_API map_keysetwithpredicate_encode(std::string const & name, Data const & predicate);
                 ...
                 * QueryResultSizeExceededException if query result size limit is configured.
                 */
                 ClientMessage HAZELCAST_API map_valueswithpredicate_encode(std::string const & name, Data const & predicate);
                 ...
                 */
                 ClientMessage HAZELCAST_API map_size_encode(std::string const & name);

                /**
                 * Returns true if this map contains no key-value mappings.
                 */
                 ClientMessage HAZELCAST_API map_isempty_encode(std::string const & name);
                 ...
                 * of these request messages for filling a request for a key set if the keys belong to different partitions.
                 */
                 ClientMessage HAZELCAST_API map_putall_encode(std::string const & name, std::vector<std::pair<Data, Data>> const & entries, bool triggerMapLoader);
                 ...
                 */
                 ClientMessage HAZELCAST_API map_clear_encode(std::string const & name);
                 ...
                 */
                 ClientMessage HAZELCAST_API map_executeonkey_encode(std::string const & name, Data const & entryProcessor, Data const & key, int64_t threadId);
                 ...
                 */
                 ClientMessage HAZELCAST_API map_submittokey_encode(std::string const & name, Data const & entryProcessor, Data const & key, int64_t threadId);

                /**
                 * Applies the user defined EntryProcessor to the all entries in the map.Returns the results mapped by each key in the map.
                 */
                 ClientMessage HAZELCAST_API map_executeonallkeys_encode(std::string const & name, Data const & entryProcessor);

                /**
                 * Applies the user defined EntryProcessor to the entries in the map which satisfies provided predicate.
                 * Returns the results mapped by each key in the map.
                 */
                 ClientMessage HAZELCAST_API map_executewithpredicate_encode(std::string const & name, Data const & entryProcessor, Data const & predicate);
                 ...
                 */
                 ClientMessage HAZELCAST_API map_executeonkeys_encode(std::string const & name, Data const & entryProcessor, std::vector<Data> const & keys);
                 ...
                 */
                 ClientMessage HAZELCAST_API map_fetchkeys_encode(std::string const & name, std::vector<std::pair<int32_t, int32_t>> const & iterationPointers, int32_t batch);

                /**
                 * Fetches specified number of entries from the specified partition starting from specified table index.
                 */
                 ClientMessage HAZELCAST_API map_fetchentries_encode(std::string const & name, std::vector<std::pair<int32_t, int32_t>> const & iterationPointers, int32_t batch);

                /**
                 * Applies the aggregation logic on all map entries and returns the result
                 */
                 ClientMessage HAZELCAST_API map_aggregate_encode(std::string const & name, Data const & aggregator);

                /**
                 * Applies the aggregation logic on map entries filtered with the Predicate and returns the result
                 */
                 ClientMessage HAZELCAST_API map_aggregatewithpredicate_encode(std::string const & name, Data const & aggregator, Data const & predicate);

                /**
                 * Applies the projection logic on all map entries and returns the result
                 */
                 ClientMessage HAZELCAST_API map_project_encode(std::string const & name, Data const & projection);

                /**
                 * Applies the projection logic on map entries filtered with the Predicate and returns the result
                 */
                 ClientMessage HAZELCAST_API map_projectwithpredicate_encode(std::string const & name, Data const & projection, Data const & predicate);

                /**
                 * Fetches invalidation metadata from partitions of map.
                 */
                 ClientMessage HAZELCAST_API map_fetchnearcacheinvalidationmetadata_encode(std::vector<std::string> const & names, boost::uuids::uuid uuid);

                /**
                 * Removes all entries which match with the supplied predicate
                 */
                 ClientMessage HAZELCAST_API map_removeall_encode(std::string const & name, Data const & predicate);

                /**
                 * Adds listener to map. This listener will be used to listen near cache invalidation events.
                 */
                 ClientMessage HAZELCAST_API map_addnearcacheinvalidationlistener_encode(std::string const & name, int32_t listenerFlags, bool localOnly);
                 ...
                 */
                 ClientMessage HAZELCAST_API map_fetchwithquery_encode(std::string const & name, std::vector<std::pair<int32_t, int32_t>> const & iterationPointers, int32_t batch, Data const & projection, Data const & predicate);
                 ...
                 */
                 ClientMessage HAZELCAST_API map_eventjournalsubscribe_encode(std::string const & name);
                 ...
                 */
                 ClientMessage HAZELCAST_API map_eventjournalread_encode(std::string const & name, int64_t startSequence, int32_t minSize, int32_t maxSize,  const Data * predicate,  const Data * projection);
                 ...
                 */
                 ClientMessage HAZELCAST_API map_setttl_encode(std::string const & name, Data const & key, int64_t ttl);
                 ...
                 * rounded to the next closest second value.
                 */
                 ClientMessage HAZELCAST_API map_putwithmaxidle_encode(std::string const & name, Data const & key, Data const & value, int64_t threadId, int64_t ttl, int64_t maxIdle);

                /**
                 * Same as put except that MapStore, if defined, will not be called to store/persist the entry.
                 * If ttl and maxIdle are 0, then the entry lives forever.
                 */
                 ClientMessage HAZELCAST_API map_puttransientwithmaxidle_encode(std::string const & name, Data const & key, Data const & value, int64_t threadId, int64_t ttl, int64_t maxIdle);

                /**
                 * Puts an entry into this map with a given ttl (time to live) value if the specified key is not already associated
                 * with a value. Entry will expire and get evicted after the ttl or maxIdle, whichever comes first.
                 */
                 ClientMessage HAZELCAST_API map_putifabsentwithmaxidle_encode(std::string const & name, Data const & key, Data const & value, int64_t threadId, int64_t ttl, int64_t maxIdle);
                 ...
                 */
                 ClientMessage HAZELCAST_API map_setwithmaxidle_encode(std::string const & name, Data const & key, Data const & value, int64_t threadId, int64_t ttl, int64_t maxIdle);

                /**
                 * Stores a key-value pair in the multimap.
                 */
                 ClientMessage HAZELCAST_API multimap_put_encode(std::string const & name, Data const & key, Data const & value, int64_t threadId);
                 ...
                 */
                 ClientMessage HAZELCAST_API multimap_get_encode(std::string const & name, Data const & key, int64_t threadId);

                /**
                 * Removes the given key value pair from the multimap.
                 */
                 ClientMessage HAZELCAST_API multimap_remove_encode(std::string const & name, Data const & key, int64_t threadId);

                /**
                 * Returns the set of keys in the multimap.The collection is NOT backed by the map, so changes to the map are NOT
                 * reflected in the collection, and vice-versa.
                 */
                 ClientMessage HAZELCAST_API multimap_keyset_encode(std::string const & name);
                 ...
                 */
                 ClientMessage HAZELCAST_API multimap_values_encode(std::string const & name);

                /**
                 * Returns the set of key-value pairs in the multimap.The collection is NOT backed by the map, so changes to the map
                 * are NOT reflected in the collection, and vice-versa
                 */
                 ClientMessage HAZELCAST_API multimap_entryset_encode(std::string const & name);

                /**
                 * Returns whether the multimap contains an entry with the key.
                 */
                 ClientMessage HAZELCAST_API multimap_containskey_encode(std::string const & name, Data const & key, int64_t threadId);

                /**
                 * Returns whether the multimap contains an entry with the value.
                 */
                 ClientMessage HAZELCAST_API multimap_containsvalue_encode(std::string const & name, Data const & value);

                /**
                 * Returns whether the multimap contains the given key-value pair.
                 */
                 ClientMessage HAZELCAST_API multimap_containsentry_encode(std::string const & name, Data const & key, Data const & value, int64_t threadId);

                /**
                 * Returns the number of key-value pairs in the multimap.
                 */
                 ClientMessage HAZELCAST_API multimap_size_encode(std::string const & name);

                /**
                 * Clears the multimap. Removes all key-value pairs.
                 */
                 ClientMessage HAZELCAST_API multimap_clear_encode(std::string const & name);

                /**
                 * Returns the number of values that match the given key in the multimap.
                 */
                 ClientMessage HAZELCAST_API multimap_valuecount_encode(std::string const & name, Data const & key, int64_t threadId);
                 ...
                 */
                 ClientMessage HAZELCAST_API multimap_addentrylistenertokey_encode(std::string const & name, Data const & key, bool includeValue, bool localOnly);
                 ...
                 */
                 ClientMessage HAZELCAST_API multimap_addentrylistener_encode(std::string const & name, bool includeValue, bool localOnly);
                 ...
                 * cluster and returns false.
                 */
                 ClientMessage HAZELCAST_API multimap_removeentrylistener_encode(std::string const & name, boost::uuids::uuid registrationId);
                 ...
                 */
                 ClientMessage HAZELCAST_API multimap_lock_encode(std::string const & name, Data const & key, int64_t threadId, int64_t ttl, int64_t referenceId);
                 ...
                 */
                 ClientMessage HAZELCAST_API multimap_trylock_encode(std::string const & name, Data const & key, int64_t threadId, int64_t lease, int64_t timeout, int64_t referenceId);

                /**
                 * Checks the lock for the specified key. If the lock is acquired, this method returns true, else it returns false.
                 */
                 ClientMessage HAZELCAST_API multimap_islocked_encode(std::string const & name, Data const & key);

                /**
                 * Releases the lock for the specified key regardless of the lock owner. It always successfully unlocks the key,
                 * never blocks and returns immediately.
                 */
                 ClientMessage HAZELCAST_API multimap_unlock_encode(std::string const & name, Data const & key, int64_t threadId, int64_t referenceId);

                /**
                 * Releases the lock for the specified key regardless of the lock owner. It always successfully unlocks the key,
                 * never blocks and returns immediately.
                 */
                 ClientMessage HAZELCAST_API multimap_forceunlock_encode(std::string const & name, Data const & key, int64_t referenceId);
                 ...
                 */
                 ClientMessage HAZELCAST_API multimap_removeentry_encode(std::string const & name, Data const & key, Data const & value, int64_t threadId);

                /**
                 * Removes all the entries with the given key.
                 */
                 ClientMessage HAZELCAST_API multimap_delete_encode(std::string const & name, Data const & key, int64_t threadId);
                 ...
                 * operation is in progress.
                 */
                 ClientMessage HAZELCAST_API multimap_putall_encode(std::string const & name, std::vector<std::pair<Data, std::vector<Data>>> const & entries);

                /**
                 * Inserts the specified element into this queue, waiting up to the specified wait time if necessary for space to
                 * become available.
                 */
                 ClientMessage HAZELCAST_API queue_offer_encode(std::string const & name, Data const & value, int64_t timeoutMillis);

                /**
                 * Inserts the specified element into this queue, waiting if necessary for space to become available.
                 */
                 ClientMessage HAZELCAST_API queue_put_encode(std::string const & name, Data const & value);

                /**
                 * Returns the number of elements in this collection.  If this collection contains more than Integer.MAX_VALUE
                 * elements, returns Integer.MAX_VALUE
                 */
                 ClientMessage HAZELCAST_API queue_size_encode(std::string const & name);

                /**
                 * Retrieves and removes the head of this queue.  This method differs from poll only in that it throws an exception
                 * if this queue is empty.
                 */
                 ClientMessage HAZELCAST_API queue_remove_encode(std::string const & name, Data const & value);

                /**
                 * Retrieves and removes the head of this queue, waiting up to the specified wait time if necessary for an element
                 * to become available.
                 */
                 ClientMessage HAZELCAST_API queue_poll_encode(std::string const & name, int64_t timeoutMillis);

                /**
                 * Retrieves and removes the head of this queue, waiting if necessary until an element becomes available.
                 */
                 ClientMessage HAZELCAST_API queue_take_encode(std::string const & name);

                /**
                 * Retrieves, but does not remove, the head of this queue, or returns null if this queue is empty.
                 */
                 ClientMessage HAZELCAST_API queue_peek_encode(std::string const & name);
                 ...
                 */
                 ClientMessage HAZELCAST_API queue_iterator_encode(std::string const & name);
                 ...
                 */
                 ClientMessage HAZELCAST_API queue_drainto_encode(std::string const & name);
                 ...
                 */
                 ClientMessage HAZELCAST_API queue_draintomaxsize_encode(std::string const & name, int32_t maxSize);
                 ...
                 */
                 ClientMessage HAZELCAST_API queue_contains_encode(std::string const & name, Data const & value);

                /**
                 * Return true if this collection contains all of the elements in the specified collection.
                 */
                 ClientMessage HAZELCAST_API queue_containsall_encode(std::string const & name, std::vector<Data> const & dataList);

                /**
                 * Removes all of this collection's elements that are also contained in the specified collection (optional operation).
                 * After this call returns, this collection will contain no elements in common with the specified collection.
                 */
                 ClientMessage HAZELCAST_API queue_compareandremoveall_encode(std::string const & name, std::vector<Data> const & dataList);

                /**
                 * Retains only the elements in this collection that are contained in the specified collection (optional operation).
                 * In other words, removes from this collection all of its elements that are not contained in the specified collection.
                 */
                 ClientMessage HAZELCAST_API queue_compareandretainall_encode(std::string const & name, std::vector<Data> const & dataList);

                /**
                 * Removes all of the elements from this collection (optional operation). The collection will be empty after this
                 * method returns.
                 */
                 ClientMessage HAZELCAST_API queue_clear_encode(std::string const & name);
                 ...
                 */
                 ClientMessage HAZELCAST_API queue_addall_encode(std::string const & name, std::vector<Data> const & dataList);

                /**
                 * Adds an listener for this collection. Listener will be notified or all collection add/remove events.
                 */
                 ClientMessage HAZELCAST_API queue_addlistener_encode(std::string const & name, bool includeValue, bool localOnly);
                 ...
                 * cluster and returns false.
                 */
                 ClientMessage HAZELCAST_API queue_removelistener_encode(std::string const & name, boost::uuids::uuid registrationId);
                 ...
                 */
                 ClientMessage HAZELCAST_API queue_remainingcapacity_encode(std::string const & name);

                /**
                 * Returns true if this collection contains no elements.
                 */
                 ClientMessage HAZELCAST_API queue_isempty_encode(std::string const & name);

                /**
                 * Publishes the message to all subscribers of this topic
                 */
                 ClientMessage HAZELCAST_API topic_publish_encode(std::string const & name, Data const & message);
                 ...
                 */
                 ClientMessage HAZELCAST_API topic_addmessagelistener_encode(std::string const & name, bool localOnly);
                 ...
                 */
                 ClientMessage HAZELCAST_API topic_removemessagelistener_encode(std::string const & name, boost::uuids::uuid registrationId);

                /**
                 * Returns the number of elements in this list.  If this list contains more than Integer.MAX_VALUE elements, returns
                 * Integer.MAX_VALUE.
                 */
                 ClientMessage HAZELCAST_API list_size_encode(std::string const & name);

                /**
                 * Returns true if this list contains the specified element.
                 */
                 ClientMessage HAZELCAST_API list_contains_encode(std::string const & name, Data const & value);

                /**
                 * Returns true if this list contains all of the elements of the specified collection.
                 */
                 ClientMessage HAZELCAST_API list_containsall_encode(std::string const & name, std::vector<Data> const & values);
                 ...
                 */
                 ClientMessage HAZELCAST_API list_add_encode(std::string const & name, Data const & value);
                 ...
                 */
                 ClientMessage HAZELCAST_API list_remove_encode(std::string const & name, Data const & value);
                 ...
                 */
                 ClientMessage HAZELCAST_API list_addall_encode(std::string const & name, std::vector<Data> const & valueList);

                /**
                 * Removes from this list all of its elements that are contained in the specified collection (optional operation).
                 */
                 ClientMessage HAZELCAST_API list_compareandremoveall_encode(std::string const & name, std::vector<Data> const & values);

                /**
                 * Retains only the elements in this list that are contained in the specified collection (optional operation).
                 * In other words, removes from this list all of its elements that are not contained in the specified collection.
                 */
                 ClientMessage HAZELCAST_API list_compareandretainall_encode(std::string const & name, std::vector<Data> const & values);

                /**
                 * Removes all of the elements from this list (optional operation). The list will be empty after this call returns.
                 */
                 ClientMessage HAZELCAST_API list_clear_encode(std::string const & name);

                /**
                 * Return the all elements of this collection
                 */
                 ClientMessage HAZELCAST_API list_getall_encode(std::string const & name);

                /**
                 * Adds an item listener for this collection. Listener will be notified for all collection add/remove events.
                 */
                 ClientMessage HAZELCAST_API list_addlistener_encode(std::string const & name, bool includeValue, bool localOnly);
                 ...
                 * cluster and returns false.
                 */
                 ClientMessage HAZELCAST_API list_removelistener_encode(std::string const & name, boost::uuids::uuid registrationId);

                /**
                 * Returns true if this list contains no elements
                 */
                 ClientMessage HAZELCAST_API list_isempty_encode(std::string const & name);
                 ...
                 * (Note that this will occur if the specified collection is this list, and it's nonempty.)
                 */
                 ClientMessage HAZELCAST_API list_addallwithindex_encode(std::string const & name, int32_t index, std::vector<Data> const & valueList);

                /**
                 * Returns the element at the specified position in this list
                 */
                 ClientMessage HAZELCAST_API list_get_encode(std::string const & name, int32_t index);

                /**
                 * The element previously at the specified position
                 */
                 ClientMessage HAZELCAST_API list_set_encode(std::string const & name, int32_t index, Data const & value);

                /**
                 * Inserts the specified element at the specified position in this list (optional operation). Shifts the element
                 * currently at that position (if any) and any subsequent elements to the right (adds one to their indices).
                 */
                 ClientMessage HAZELCAST_API list_addwithindex_encode(std::string const & name, int32_t index, Data const & value);
                 ...
                 */
                 ClientMessage HAZELCAST_API list_removewithindex_encode(std::string const & name, int32_t index);

                /**
                 * Returns the index of the last occurrence of the specified element in this list, or -1 if this list does not
                 * contain the element.
                 */
                 ClientMessage HAZELCAST_API list_lastindexof_encode(std::string const & name, Data const & value);

                /**
                 * Returns the index of the first occurrence of the specified element in this list, or -1 if this list does not
                 * contain the element.
                 */
                 ClientMessage HAZELCAST_API list_indexof_encode(std::string const & name, Data const & value);
                 ...
                 */
                 ClientMessage HAZELCAST_API list_sub_encode(std::string const & name, int32_t from, int32_t to);

                /**
                 * Returns an iterator over the elements in this list in proper sequence.
                 */
                 ClientMessage HAZELCAST_API list_iterator_encode(std::string const & name);
                 ...
                 */
                 ClientMessage HAZELCAST_API list_listiterator_encode(std::string const & name, int32_t index);

                /**
                 * Returns the number of elements in this set (its cardinality). If this set contains more than Integer.MAX_VALUE
                 * elements, returns Integer.MAX_VALUE.
                 */
                 ClientMessage HAZELCAST_API set_size_encode(std::string const & name);

                /**
                 * Returns true if this set contains the specified element.
                 */
                 ClientMessage HAZELCAST_API set_contains_encode(std::string const & name, Data const & value);
                 ...
                 */
                 ClientMessage HAZELCAST_API set_containsall_encode(std::string const & name, std::vector<Data> const & items);
                 ...
                 */
                 ClientMessage HAZELCAST_API set_add_encode(std::string const & name, Data const & value);
                 ...
                 */
                 ClientMessage HAZELCAST_API set_remove_encode(std::string const & name, Data const & value);
                 ...
                 */
                 ClientMessage HAZELCAST_API set_addall_encode(std::string const & name, std::vector<Data> const & valueList);
                 ...
                 */
                 ClientMessage HAZELCAST_API set_compareandremoveall_encode(std::string const & name, std::vector<Data> const & values);
                 ...
                 */
                 ClientMessage HAZELCAST_API set_compareandretainall_encode(std::string const & name, std::vector<Data> const & values);

                /**
                 * Removes all of the elements from this set (optional operation). The set will be empty after this call returns.
                 */
                 ClientMessage HAZELCAST_API set_clear_encode(std::string const & name);

                /**
                 * Return the all elements of this collection
                 */
                 ClientMessage HAZELCAST_API set_getall_encode(std::string const & name);

                /**
                 * Adds an item listener for this collection. Listener will be notified for all collection add/remove events.
                 */
                 ClientMessage HAZELCAST_API set_addlistener_encode(std::string const & name, bool includeValue, bool localOnly);
                 ...
                 * cluster and returns false.
                 */
                 ClientMessage HAZELCAST_API set_removelistener_encode(std::string const & name, boost::uuids::uuid registrationId);
                 ...
                 */
                 ClientMessage HAZELCAST_API replicatedmap_put_encode(std::string const & name, Data const & key, Data const & value, int64_t ttl);

                /**
                 * Returns the number of key-value mappings in this map. If the map contains more than Integer.MAX_VALUE elements,
                 * returns Integer.MAX_VALUE.
                 */
                 ClientMessage HAZELCAST_API replicatedmap_size_encode(std::string const & name);

                /**
                 * Return true if this map contains no key-value mappings
                 */
                 ClientMessage HAZELCAST_API replicatedmap_isempty_encode(std::string const & name);

                /**
                 * Returns true if this map contains a mapping for the specified key.
                 */
                 ClientMessage HAZELCAST_API replicatedmap_containskey_encode(std::string const & name, Data const & key);
                 ...
                 */
                 ClientMessage HAZELCAST_API replicatedmap_containsvalue_encode(std::string const & name, Data const & value);
                 ...
                 */
                 ClientMessage HAZELCAST_API replicatedmap_get_encode(std::string const & name, Data const & key);
                 ...
                 */
                 ClientMessage HAZELCAST_API replicatedmap_remove_encode(std::string const & name, Data const & key);
                 ...
                 * operation is in progress.
                 */
                 ClientMessage HAZELCAST_API replicatedmap_putall_encode(std::string const & name, std::vector<std::pair<Data, Data>> const & entries);
                 ...
                 */
                 ClientMessage HAZELCAST_API replicatedmap_clear_encode(std::string const & name);
                 ...
                 */
                 ClientMessage HAZELCAST_API replicatedmap_addentrylistenertokeywithpredicate_encode(std::string const & name, Data const & key, Data const & predicate, bool localOnly);
                 ...
                 * events filtered by the given predicate.
                 */
                 ClientMessage HAZELCAST_API replicatedmap_addentrylistenerwithpredicate_encode(std::string const & name, Data const & predicate, bool localOnly);
                 ...
                 */
                 ClientMessage HAZELCAST_API replicatedmap_addentrylistenertokey_encode(std::string const & name, Data const & key, bool localOnly);
                 ...
                 */
                 ClientMessage HAZELCAST_API replicatedmap_addentrylistener_encode(std::string const & name, bool localOnly);
                 ...
                 * cluster and returns false.
                 */
                 ClientMessage HAZELCAST_API replicatedmap_removeentrylistener_encode(std::string const & name, boost::uuids::uuid registrationId);
                 ...
                 */
                 ClientMessage HAZELCAST_API replicatedmap_keyset_encode(std::string const & name);

                /**
                 * Returns a lazy collection view of the values contained in this map.
                 */
                 ClientMessage HAZELCAST_API replicatedmap_values_encode(std::string const & name);

                /**
                 * Gets a lazy set view of the mappings contained in this map.
                 */
                 ClientMessage HAZELCAST_API replicatedmap_entryset_encode(std::string const & name);
                 ...
                 */
                 ClientMessage HAZELCAST_API replicatedmap_addnearcacheentrylistener_encode(std::string const & name, bool includeValue, bool localOnly);
                 ...
                 */
                 ClientMessage HAZELCAST_API transactionalmap_containskey_encode(std::string const & name, boost::uuids::uuid txnId, int64_t threadId, Data const & key);

                /**
                 * Returns the value for the specified key, or null if this map does not contain this key.
                 */
                 ClientMessage HAZELCAST_API transactionalmap_get_encode(std::string const & name, boost::uuids::uuid txnId, int64_t threadId, Data const & key);
                 ...
                 */
                 ClientMessage HAZELCAST_API transactionalmap_getforupdate_encode(std::string const & name, boost::uuids::uuid txnId, int64_t threadId, Data const & key);

                /**
                 * Returns the number of entries in this map.
                 */
                 ClientMessage HAZELCAST_API transactionalmap_size_encode(std::string const & name, boost::uuids::uuid txnId, int64_t threadId);

                /**
                 * Returns true if this map contains no entries.
                 */
                 ClientMessage HAZELCAST_API transactionalmap_isempty_encode(std::string const & name, boost::uuids::uuid txnId, int64_t threadId);
                 ...
                 */
                 ClientMessage HAZELCAST_API transactionalmap_put_encode(std::string const & name, boost::uuids::uuid txnId, int64_t threadId, Data const & key, Data const & value, int64_t ttl);
                 ...
                 */
                 ClientMessage HAZELCAST_API transactionalmap_set_encode(std::string const & name, boost::uuids::uuid txnId, int64_t threadId, Data const & key, Data const & value);
                 ...
                 */
                 ClientMessage HAZELCAST_API transactionalmap_putifabsent_encode(std::string const & name, boost::uuids::uuid txnId, int64_t threadId, Data const & key, Data const & value);
                 ...
                 */
                 ClientMessage HAZELCAST_API transactionalmap_replace_encode(std::string const & name, boost::uuids::uuid txnId, int64_t threadId, Data const & key, Data const & value);

                /**
                 * Replaces the entry for a key only if currently mapped to a given value. The object to be replaced will be
                 * accessible only in the current transaction context until the transaction is committed.
                 */
                 ClientMessage HAZELCAST_API transactionalmap_replaceifsame_encode(std::string const & name, boost::uuids::uuid txnId, int64_t threadId, Data const & key, Data const & oldValue, Data const & newValue);
                 ...
                 */
                 ClientMessage HAZELCAST_API transactionalmap_remove_encode(std::string const & name, boost::uuids::uuid txnId, int64_t threadId, Data const & key);
                 ...
                 */
                 ClientMessage HAZELCAST_API transactionalmap_delete_encode(std::string const & name, boost::uuids::uuid txnId, int64_t threadId, Data const & key);
                 ...
                 */
                 ClientMessage HAZELCAST_API transactionalmap_removeifsame_encode(std::string const & name, boost::uuids::uuid txnId, int64_t threadId, Data const & key, Data const & value);
                 ...
                 */
                 ClientMessage HAZELCAST_API transactionalmap_keyset_encode(std::string const & name, boost::uuids::uuid txnId, int64_t threadId);
                 ...
                 * QueryResultSizeExceededException if query result size limit is configured.
                 */
                 ClientMessage HAZELCAST_API transactionalmap_keysetwithpredicate_encode(std::string const & name, boost::uuids::uuid txnId, int64_t threadId, Data const & predicate);
                 ...
                 */
                 ClientMessage HAZELCAST_API transactionalmap_values_encode(std::string const & name, boost::uuids::uuid txnId, int64_t threadId);
                 ...
                 * a QueryResultSizeExceededException if query result size limit is configured.
                 */
                 ClientMessage HAZELCAST_API transactionalmap_valueswithpredicate_encode(std::string const & name, boost::uuids::uuid txnId, int64_t threadId, Data const & predicate);

                /**
                 * Returns true if this map contains an entry for the specified value.
                 */
                 ClientMessage HAZELCAST_API transactionalmap_containsvalue_encode(std::string const & name, boost::uuids::uuid txnId, int64_t threadId, Data const & value);

                /**
                 * Stores a key-value pair in the multimap.
                 */
                 ClientMessage HAZELCAST_API transactionalmultimap_put_encode(std::string const & name, boost::uuids::uuid txnId, int64_t threadId, Data const & key, Data const & value);

                /**
                 * Returns the collection of values associated with the key.
                 */
                 ClientMessage HAZELCAST_API transactionalmultimap_get_encode(std::string const & name, boost::uuids::uuid txnId, int64_t threadId, Data const & key);

                /**
                 * Removes the given key value pair from the multimap.
                 */
                 ClientMessage HAZELCAST_API transactionalmultimap_remove_encode(std::string const & name, boost::uuids::uuid txnId, int64_t threadId, Data const & key);

                /**
                 * Removes all the entries associated with the given key.
                 */
                 ClientMessage HAZELCAST_API transactionalmultimap_removeentry_encode(std::string const & name, boost::uuids::uuid txnId, int64_t threadId, Data const & key, Data const & value);

                /**
                 * Returns the number of values matching the given key in the multimap.
                 */
                 ClientMessage HAZELCAST_API transactionalmultimap_valuecount_encode(std::string const & name, boost::uuids::uuid txnId, int64_t threadId, Data const & key);

                /**
                 * Returns the number of key-value pairs in the multimap.
                 */
                 ClientMessage HAZELCAST_API transactionalmultimap_size_encode(std::string const & name, boost::uuids::uuid txnId, int64_t threadId);

                /**
                 * Add new item to transactional set.
                 */
                 ClientMessage HAZELCAST_API transactionalset_add_encode(std::string const & name, boost::uuids::uuid txnId, int64_t threadId, Data const & item);

                /**
                 * Remove item from transactional set.
                 */
                 ClientMessage HAZELCAST_API transactionalset_remove_encode(std::string const & name, boost::uuids::uuid txnId, int64_t threadId, Data const & item);

                /**
                 * Returns the size of the set.
                 */
                 ClientMessage HAZELCAST_API transactionalset_size_encode(std::string const & name, boost::uuids::uuid txnId, int64_t threadId);

                /**
                 * Adds a new item to the transactional list.
                 */
                 ClientMessage HAZELCAST_API transactionallist_add_encode(std::string const & name, boost::uuids::uuid txnId, int64_t threadId, Data const & item);

                /**
                 * Remove item from the transactional list
                 */
                 ClientMessage HAZELCAST_API transactionallist_remove_encode(std::string const & name, boost::uuids::uuid txnId, int64_t threadId, Data const & item);

                /**
                 * Returns the size of the list
                 */
                 ClientMessage HAZELCAST_API transactionallist_size_encode(std::string const & name, boost::uuids::uuid txnId, int64_t threadId);

                /**
                 * Inserts the specified element into this queue, waiting up to the specified wait time if necessary for space to
                 * become available.
                 */
                 ClientMessage HAZELCAST_API transactionalqueue_offer_encode(std::string const & name, boost::uuids::uuid txnId, int64_t threadId, Data const & item, int64_t timeout);

                /**
                 * Retrieves and removes the head of this queue, waiting if necessary until an element becomes available.
                 */
                 ClientMessage HAZELCAST_API transactionalqueue_take_encode(std::string const & name, boost::uuids::uuid txnId, int64_t threadId);

                /**
                 * Retrieves and removes the head of this queue, waiting up to the specified wait time if necessary for an element
                 * to become available.
                 */
                 ClientMessage HAZELCAST_API transactionalqueue_poll_encode(std::string const & name, boost::uuids::uuid txnId, int64_t threadId, int64_t timeout);

                /**
                 * Retrieves, but does not remove, the head of this queue, or returns null if this queue is empty.
                 */
                 ClientMessage HAZELCAST_API transactionalqueue_peek_encode(std::string const & name, boost::uuids::uuid txnId, int64_t threadId, int64_t timeout);
                 ...
                 */
                 ClientMessage HAZELCAST_API ringbuffer_size_encode(std::string const & name);

                /**
                 * Returns the sequence of the tail. The tail is the side of the ringbuffer where the items are added to.
                 * The initial value of the tail is -1.
                 */
                 ClientMessage HAZELCAST_API ringbuffer_tailsequence_encode(std::string const & name);
                 ...
                 */
                 ClientMessage HAZELCAST_API ringbuffer_headsequence_encode(std::string const & name);

                /**
                 * Returns the capacity of this Ringbuffer.
                 */
                 ClientMessage HAZELCAST_API ringbuffer_capacity_encode(std::string const & name);
                 ...
                 */
                 ClientMessage HAZELCAST_API ringbuffer_remainingcapacity_encode(std::string const & name);
                 ...
                 * to find that item.
                 */
                 ClientMessage HAZELCAST_API ringbuffer_add_encode(std::string const & name, int32_t overflowPolicy, Data const & value);
                 ...
                 */
                 ClientMessage HAZELCAST_API ringbuffer_readone_encode(std::string const & name, int64_t sequence);
                 ...
                 */
                 ClientMessage HAZELCAST_API ringbuffer_addall_encode(std::string const & name, std::vector<Data> const & valueList, int32_t overflowPolicy);
