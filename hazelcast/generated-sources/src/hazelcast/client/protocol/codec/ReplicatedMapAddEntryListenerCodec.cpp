...
namespace hazelcast {
    namespace client {
        namespace protocol {
            namespace codec {
                const ReplicatedMapMessageType ReplicatedMapAddEntryListenerCodec::RequestParameters::TYPE = REPLICATEDMAP_ADDENTRYLISTENER;
                const bool ReplicatedMapAddEntryListenerCodec::RequestParameters::RETRYABLE = true;
                ...
                void ReplicatedMapAddEntryListenerCodec::AbstractEventHandler::handle(std::auto_ptr<protocol::ClientMessage> clientMessage) {
                    ...
                    switch (messageType) {
                        ...
                        default:
                            char buf[300];
                            sprintf(buf, "[ReplicatedMapAddEntryListenerCodec::AbstractEventHandler::handle] Unknown message type (%d) received on event handler.", clientMessage->getMessageType());
