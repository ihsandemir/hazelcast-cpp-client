...
namespace hazelcast {
    namespace client {
        namespace protocol {
            namespace codec {
                const QueueMessageType QueueAddListenerCodec::RequestParameters::TYPE = QUEUE_ADDLISTENER;
                const bool QueueAddListenerCodec::RequestParameters::RETRYABLE = true;
                ...
                void QueueAddListenerCodec::AbstractEventHandler::handle(std::auto_ptr<protocol::ClientMessage> clientMessage) {
                    ...
                    switch (messageType) {
                        ...
                        default:
                            char buf[300];
                            sprintf(buf, "[QueueAddListenerCodec::AbstractEventHandler::handle] Unknown message type (%d) received on event handler.", clientMessage->getMessageType());
