...
namespace hazelcast {
    namespace client {
        namespace protocol {
            namespace codec {
                const MapMessageType MapAddNearCacheEntryListenerCodec::RequestParameters::TYPE = MAP_ADDNEARCACHEENTRYLISTENER;
                const bool MapAddNearCacheEntryListenerCodec::RequestParameters::RETRYABLE = true;
                ...
                void MapAddNearCacheEntryListenerCodec::AbstractEventHandler::handle(std::auto_ptr<protocol::ClientMessage> clientMessage) {
                    ...
                    switch (messageType) {
                        ...
                        default:
                            char buf[300];
                            sprintf(buf, "[MapAddNearCacheEntryListenerCodec::AbstractEventHandler::handle] Unknown message type (%d) received on event handler.", clientMessage->getMessageType());
