...
namespace hazelcast {
    namespace client {
        namespace protocol {
            namespace codec {
                const ReplicatedMapMessageType ReplicatedMapAddEntryListenerToKeyWithPredicateCodec::RequestParameters::TYPE = REPLICATEDMAP_ADDENTRYLISTENERTOKEYWITHPREDICATE;
                const bool ReplicatedMapAddEntryListenerToKeyWithPredicateCodec::RequestParameters::RETRYABLE = true;
                ...
                void ReplicatedMapAddEntryListenerToKeyWithPredicateCodec::AbstractEventHandler::handle(std::auto_ptr<protocol::ClientMessage> clientMessage) {
                    ...
                    switch (messageType) {
                        ...
                        default:
                            char buf[300];
                            sprintf(buf, "[ReplicatedMapAddEntryListenerToKeyWithPredicateCodec::AbstractEventHandler::handle] Unknown message type (%d) received on event handler.", clientMessage->getMessageType());
