...
namespace hazelcast {
    namespace client {
        namespace protocol {
            namespace codec {
                const ReplicatedMapMessageType ReplicatedMapAddEntryListenerToKeyCodec::RequestParameters::TYPE = REPLICATEDMAP_ADDENTRYLISTENERTOKEY;
                const bool ReplicatedMapAddEntryListenerToKeyCodec::RequestParameters::RETRYABLE = true;
                ...
                void ReplicatedMapAddEntryListenerToKeyCodec::AbstractEventHandler::handle(std::auto_ptr<protocol::ClientMessage> clientMessage) {
                    ...
                    switch (messageType) {
                        ...
                        default:
                            char buf[300];
                            sprintf(buf, "[ReplicatedMapAddEntryListenerToKeyCodec::AbstractEventHandler::handle] Unknown message type (%d) received on event handler.", clientMessage->getMessageType());
