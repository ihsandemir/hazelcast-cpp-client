...
namespace hazelcast {
    namespace client {
        namespace protocol {
            namespace codec {
                const MapMessageType MapAddPartitionLostListenerCodec::RequestParameters::TYPE = MAP_ADDPARTITIONLOSTLISTENER;
                const bool MapAddPartitionLostListenerCodec::RequestParameters::RETRYABLE = true;
                ...
                void MapAddPartitionLostListenerCodec::AbstractEventHandler::handle(std::auto_ptr<protocol::ClientMessage> clientMessage) {
                    ...
                    switch (messageType) {
                        ...
                        default:
                            char buf[300];
                            sprintf(buf, "[MapAddPartitionLostListenerCodec::AbstractEventHandler::handle] Unknown message type (%d) received on event handler.", clientMessage->getMessageType());
