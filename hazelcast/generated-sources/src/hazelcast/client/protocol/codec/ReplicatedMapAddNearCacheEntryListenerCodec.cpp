...
namespace hazelcast {
    namespace client {
        namespace protocol {
            namespace codec {
                const ReplicatedMapMessageType ReplicatedMapAddNearCacheEntryListenerCodec::RequestParameters::TYPE = REPLICATEDMAP_ADDNEARCACHEENTRYLISTENER;
                const bool ReplicatedMapAddNearCacheEntryListenerCodec::RequestParameters::RETRYABLE = true;
                ...
                void ReplicatedMapAddNearCacheEntryListenerCodec::AbstractEventHandler::handle(std::auto_ptr<protocol::ClientMessage> clientMessage) {
                    ...
                    switch (messageType) {
                        ...
                        default:
                            char buf[300];
                            sprintf(buf, "[ReplicatedMapAddNearCacheEntryListenerCodec::AbstractEventHandler::handle] Unknown message type (%d) received on event handler.", clientMessage->getMessageType());
