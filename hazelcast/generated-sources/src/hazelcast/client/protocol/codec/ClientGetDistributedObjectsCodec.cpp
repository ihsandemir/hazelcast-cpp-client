...
namespace hazelcast {
    namespace client {
        namespace protocol {
            namespace codec {
                const ClientMessageType ClientGetDistributedObjectsCodec::RequestParameters::TYPE = CLIENT_GETDISTRIBUTEDOBJECTS;
                ...
                ClientGetDistributedObjectsCodec::ResponseParameters::ResponseParameters(ClientMessage &clientMessage) {
                    ...
                    response = clientMessage.getArray<DistributedObjectInfo >();
                }
