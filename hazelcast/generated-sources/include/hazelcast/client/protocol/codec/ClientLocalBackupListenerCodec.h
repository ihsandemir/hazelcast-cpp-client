 ...
 */
#ifndef HAZELCAST_CLIENT_PROTOCOL_CODEC_CLIENTLOCALBACKUPLISTENERCODEC_H_
#define HAZELCAST_CLIENT_PROTOCOL_CODEC_CLIENTLOCALBACKUPLISTENERCODEC_H_
...
namespace hazelcast {
    namespace client {
        ...
        namespace protocol {
            namespace codec {
                class HAZELCAST_API ClientLocalBackupListenerCodec {
                public:
                    ...
                    public:
                        ...
                        virtual void handleBackupEventV19(const int64_t &backupId) = 0;
...
#endif /* HAZELCAST_CLIENT_PROTOCOL_CODEC_CLIENTLOCALBACKUPLISTENERCODEC_H_ */
