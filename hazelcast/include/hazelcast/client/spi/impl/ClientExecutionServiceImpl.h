        ...
        namespace spi {
            namespace impl {
                ...
                public:
                    ...
                    boost::asio::io_context &get_user_executor();

                private:
                    std::unique_ptr<hazelcast::util::thread_pool> internal_executor_;
                    std::unique_ptr<hazelcast::util::thread_pool> user_executor_;
