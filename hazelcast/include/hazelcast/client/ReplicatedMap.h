...
namespace hazelcast {
    namespace client {
        ...
        public:
             ...
             */
            virtual boost::future<boost::optional<V>>  put(const K &key, const V &value, int64_t ttl) = 0;
            ...
            */
            virtual boost::future<void>  putAll(const std::map<K, V> &entries) = 0;
             ...
             */
            virtual boost::future<void>  clear() = 0;
             ...
             */
            virtual boost::future<bool> removeEntryListener(const boost::future<std::string> &registrationId) = 0;
             ...
             */
            virtual boost::future<std::string> addEntryListener(const std::shared_ptr<EntryListener<K, V> > &listener) = 0;
             ...
             */
            virtual boost::future<std::string> addEntryListener(const std::shared_ptr<EntryListener<K, V> > &listener, const K &key) = 0;
             ...
             */
            virtual boost::future<std::shared_ptr<DataArray<V>> values() = 0;
             ...
             */
            virtual boost::future<std::shared_ptr<LazyEntryArray<K, V>>> entrySet() = 0;
             ...
             */
            virtual boost::future<std::shared_ptr<DataArray<K>> keySet() = 0;

            /**
             *
             * @return The number of the replicated map entries in the cluster.
             */
            virtual boost::future<int32_t> size() = 0;

            /**
             *
             * @return true if the replicated map is empty, false otherwise
             */
            virtual boost::future<bool> isEmpty() = 0;
             ...
             */
            virtual boost::future<bool> containsKey(const K &key) = 0;
             ...
             */
            virtual boost::future<bool> containsValue(const V &value) = 0;
             ...
             */
            virtual boost::future<boost::optional<V>>  get(const K &key) = 0;
             ...
             */
            virtual boost::future<boost::optional<V>>  put(const K &key, const V &value) = 0;
             ...
             */
            virtual boost::future<boost::optional<V>>  remove(const K &key) = 0;
        };
    }
}
