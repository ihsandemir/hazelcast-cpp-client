        ...
        namespace test {
            ...
            protected:
                ...
                static void SetUpTestCase() {
                    ...
                    imap = client->getMap<int, MapGlobalSerializerTest::UnknownObject>("UnknownObject");
                }
